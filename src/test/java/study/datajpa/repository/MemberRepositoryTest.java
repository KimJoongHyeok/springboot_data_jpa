...
//        em.clear(); // 영속성 컨텍스트를 꺠끗이 정리하여 아래 조회 쿼리에서 DB에서 직접 조회해옴, Spring Data JPA 에는 이 기능을 @Modifying(clearAutomatically = true) 로 처리 가능
...
//        List<Member> members = memberRepository.findMemberFetchJoin();
    ...
    public void queryByExample() {
        ...
        Example<Member> example = Example.of(member, mather);
...
//        List<UsernameOnlyDto> result = memberRepository.findProjectionsByUsername("m1");
    ...
    public void nativeQuery() {
        ...
        for (MemberProjection memberProjection : result2) {
